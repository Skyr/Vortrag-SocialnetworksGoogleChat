...
\begin{frame}{Marc L. - Ein Google-Portrait\endnote{\url{http://stefan.ploing.de/2009-05-13-marc-l-google-portrait}}}
	\begin{itemize}
...
\begin{frame}{Das sind die sichtbaren Daten... was gibt es noch?}
	...
	\begin{itemize}
		...
		\endnote{\url{http://www.netzpolitik.org/2009/netzpolitik-interview-sicherheitsluecken-bei-der-vz-gruppe/}}
		\endnote{\url{http://blogbar.de/archiv/2007/02/27/oooops-bei-studivz-muss-was-absolut-grobes-passiert-sein/}})
		\item Mailadressen aller Facebook-Profile kurzzeitig sichtbar%
		\endnote{\url{http://www.heise.de/newsticker/meldung/Datenpanne-bei-Facebook-968117.html}}
		\item Profile und Accounts bei haefft.de zugreifbar%
		\endnote{\url{http://www.ccc.de/de/updates/2009/haefft-datenloch}}
	\end{itemize}
	...
	\begin{itemize}
		...
		\endnote{\url{http://therumpus.net/2010/01/conversations-about-the-internet-5-anonymous-facebook-employee/?full=yes}}
...
\begin{frame}{Das Geschäft mit den Daten}
	\begin{itemize}
		\item VZnet verkauft personalisierte Bannerwerbung (wird auf ihren Webseiten anschaulich erklärt)
		\item<2-> MySpace verkauft "`anonymisierte"', vorausgewertete Daten
